...
void DisSelfTest(void)
{
	...
	GUI_DisString_EN(0, 6, "Performing", &Font16,WHITE, BLACK );
...
void DrawError(void)
{
	GUI_Disbitmap(112, 23, Messaging_Delete_Message_iconx16, PX_16, PX_16);
}

void DrawComs(void)
{
	GUI_Disbitmap(66, 2, Network_Data_In_Both_Directions_iconx16, PX_16, PX_16);
}

void DrawConCloud(void)
{
	GUI_Disbitmap(89, 2, wifi_iconx16_black, PX_16, PX_16);
}

void DrawSystemPower(void)
{
	GUI_Disbitmap(112, 2, MyPower_iconx16, PX_16, PX_16);
}

void DrawAutoModeOn(void)
{
	GUI_Disbitmap(5, 2, Auto_16px_46px, PX_46, PX_16);
	//GUI_Disbitmap(60,48,Industry_Robot_iconx16,PX_16,PX_16);
	//GUI_Disbitmap(78,48,Very_Basic_Accept_icon,PX_16,PX_16);
}

void DrawAutoModeOff(void)
{
	GUI_Disbitmap(5, 2, NoAuto_16px_46px, PX_46, PX_16);
	//GUI_Disbitmap(60,48,Industry_Robot_iconx16,PX_16,PX_16);
	//GUI_Disbitmap(78,48,Very_Basic_Cancel_icon,PX_16,PX_16);
}
